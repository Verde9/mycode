...
# name = classinfo["all"][10]["name"]
# spirit = classinfo["all"][10]["spirit animal"]


# print(f"My name is {name} and my spirit animal is {spirit}.")


for item in classinfo['all']:
    name = item["name"]
    skill = item["skill level"]
    spirit = item["spirit animal"]
    superPower = item["super power"]

    print(f"{name}, a {skill} {spirit} of a programmer, possesses a {superPower} factor for moonlighting as a superhero!")
    print()
    time.sleep(1)
